...
{
    Task<IEnumerable<ClothingItemDto>> GetAllAsync(Guid userId, CancellationToken cancellationToken = default);
    Task<ClothingItemDto?> GetByIdAsync(Guid id, Guid userId, CancellationToken cancellationToken = default);
